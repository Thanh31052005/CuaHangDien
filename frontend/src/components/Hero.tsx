      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden min-h-[320px] lg:min-h-[380px] group">
            <img
              src="https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?q=80&w=1400&auto=format&fit=crop"
              alt="Hero banner"
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-8 lg:p-12">
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <button onClick={() => navigate('products', { category: 'Đèn' })} className="btn btn-outline btn-sm text-white border-white/40 hover:bg-white/10 hover:text-white hover:border-white/60">
                  Xem đèn LED
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="relative rounded-2xl overflow-hidden h-44 group cursor-pointer" onClick={() => navigate('products', { category: 'Quạt' })}>
              <img
            ...
            <div className="relative rounded-2xl overflow-hidden h-44 group cursor-pointer" onClick={() => navigate('products', { category: 'Pin' })}>
              <img
                src="https://images.unsplash.com/photo-1606806116070-0f4b2b5cc06b?q=80&w=800&auto=format&fit=crop"
                alt="Pin điện"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/65 to-transparent" />
          ...
          {[
            ...
            <div key={b.title} className="bg-base-100 rounded-xl p-4 flex items-center gap-3 border border-base-200 hover:border-primary/30 hover:shadow-sm transition-all">
              ...
              <div>
                ...
                <p className="text-xs text-base-content/60">{b.sub}</p>
              </div>
            </div>
          ))}
        </div>

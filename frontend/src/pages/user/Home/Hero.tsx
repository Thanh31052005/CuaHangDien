    ...
    <section className="bg-base-200/50">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="lg:col-span-2 relative rounded-3xl overflow-hidden min-h-[320px] lg:min-h-[400px] group">
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-8 lg:p-12">
              ...
              <h1 className="text-3xl lg:text-5xl font-black text-white leading-tight mb-4">
                V?t tu di?n<br /><span className="bg-gradient-to-r from-primary to-indigo-400 bg-clip-text text-transparent">ch?t lu?ng cao</span>
              </h1>
              <p className="text-white/70 text-sm lg:text-base mb-7 max-w-sm leading-relaxed">
                Cung c?p d�n, qu?t, pin, d�y di?n v� ph? ki?n di?n da d?ng � ch�nh h�ng, gi� t?t, giao h�ng nhanh.
              </p>
              <div className="flex gap-3 flex-wrap">
                ...
                <button onClick={() => navigate(ROUTES.PRODUCTS, { category: '��n' })} className="btn btn-ghost btn-sm text-white/80 border border-white/20 hover:bg-white/10 hover:text-white rounded-xl backdrop-blur-sm">Xem d�n LED</button>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <div className="relative rounded-3xl overflow-hidden h-[192px] group cursor-pointer" onClick={() => navigate(ROUTES.PRODUCTS, { category: 'Qu?t' })}>
              <img src="https://images.unsplash.com/photo-1585771724684-38269d6639fd?q=80&w=800&auto=format&fit=crop" alt="Qu?t" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-5">
                <p className="text-white/60 text-xs mb-1 font-medium">�ang c� h�ng</p>
                <p className="text-white font-bold text-lg">Qu?t di?n c�c lo?i</p>
                <p className="text-primary font-bold text-sm flex items-center gap-1 mt-0.5">
                  Qu?t tr?n � Qu?t d?ng � Qu?t b�n
            ...
            <div className="relative rounded-3xl overflow-hidden h-[192px] group cursor-pointer" onClick={() => navigate(ROUTES.PRODUCTS, { category: 'Pin' })}>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-5">
                <p className="text-white/60 text-xs mb-1 font-medium">Ch�nh h�ng</p>
                <p className="text-white font-bold text-lg">Pin & ?c quy</p>
                <p className="text-primary font-bold text-sm flex items-center gap-1 mt-0.5">
                  Gi?m d?n 24%
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 stagger-children">
          {[
            { icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>, title: 'Giao h�ng mi?n ph�', sub: '�on t? 500.000d' },
            { icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>, title: '�?i tr? 30 ng�y', sub: 'Kh�ng c?n l� do' },
            { icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>, title: 'H�ng ch�nh h�ng', sub: 'C� ho� don d?y d?' },
            { icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>, title: 'Thanh to�n an to�n', sub: 'COD � Chuy?n kho?n' },
          ].map(b => (
